...
pub fn cmd() {
    ...
    // since the actual command itself counts as an arguments
    //     this checks if at least one non-command argument is made
    if args.len() >= 2 {
        ...
        match args[1].as_ref() {
            ...
            "toot" => {
                ...
                // if no additional argument is passed
                //     then the user only wants to post an imageless toot
                else {
                    gui(mastodon, false);
                }
            }
            ...
            "tweet" => {
                ...
                // if no additonal argument is passed
                //     then the user only wants to post an imageless tweet
                else {
                    gui(twitter, false);
                }
            }
